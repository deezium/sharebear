...
urlpatterns = patterns('',
    ...
    url(r'^recipients/(?P<meta_message_id>[\d]+)/$', 'sharebear_app.views.recipients', name='messages_recipients'),
    ...
    url(r'^like/(?P<message_id>[\d]+)/$', 'sharebear_app.views.like', name='messages_like'),
